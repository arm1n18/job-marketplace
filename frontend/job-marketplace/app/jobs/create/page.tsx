...
import { FilterDropDown, CheckBoxesSection, Button, Input, Slider, Textarea, KeywordsInput } from "@/components/ui";
...
export default function CreateJob() {
    ...
    salary_from: 0, salary_to: 0, city: '', employment_name: '', experience: 0, description: '', requirements: '', offer: '', email: email ? email : "", id: id ? id : 0});
                    ...
                    <div className="grid mb-12 lg:grid-cols-2">
                        ...
                        <div className="lg:w-[464px]">
                            <KeywordsInput
                               ...
                               setKeywords={(newKeywords) => setformData({...formData, keywords: newKeywords})}
