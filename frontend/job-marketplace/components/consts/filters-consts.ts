...
export const cities = [
    {name: 'Одеса', subgroups: []},
    {name: 'Київ', subgroups: []},
    {name: 'Львів', subgroups: []},
    {name: 'Харків', subgroups: []},
    {name: 'Дніпро', subgroups: []},
    {name: 'Вінниця', subgroups: []},
...
export const experience = [
    ...
    {name: '4 роки', subgroups: []},
    {name: '5 років', subgroups: []},
    {name: '6 років', subgroups: []},
    {name: '7 років', subgroups: []},
    {name: '8 років', subgroups: []},
    {name: '9 років', subgroups: []},
    {name: '10+ років', subgroups: []},
]