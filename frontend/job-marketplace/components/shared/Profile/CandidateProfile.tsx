...
import { KeywordsInput } from "@/components/ui";
            ...
            <div className="flex flex-col lg:gap-12 lg:flex-row">
                ...
                <div>
                    ...
                    <div className="w-full mb-6 lg:w-[464px]">
                     ...
                     <div className="w-full mb-6 lg:w-[464px]">
                        <label className="text-common-dark">Ключові слова</label>
                        <KeywordsInput
                            className="mt-2"
                            setKeywords={() => {}}
                            keywords={data && data.keywords}
                            defaultValue={data && data.keywords}
                        />
                    ...
                    <div className="w-full mb-6 lg:w-[464px]">
                        ...
                        <div className="w-full flex flex-col justify-between h-9 mt-2">
                            ...
                            <Slider
                                ...
                                step={0.5}
                                className="w-full"
                                onValueChange={(minValue) => {handleExperienceSubmit(minValue[0]);}}
                            />
                        </div>
                    </div>
                    {/* {Формат} */}
                ...
                <div className="w-full mb-6 lg:w-[464px] flex flex-col">
                    ...
                    <div className="mb-6">
                        <label className="text-common-dark">Досвід роботи</label>
                        <Textarea className={`${errors.work_experience && "border-red-500"} bg-[#F9FAFB] mt-2 min-h-80`} placeholder="Досвід роботи"
                    ...
                    <div>
                        ...
                        <Textarea className="bg-[#F9FAFB] min-h-80" placeholder="Досягнення"
